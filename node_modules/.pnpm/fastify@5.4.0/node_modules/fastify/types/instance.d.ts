...
import { AddContentTypeParser, ConstructorAction, FastifyBodyParser, ProtoAction, getDefaultJsonParser, hasContentTypeParser, removeAllContentTypeParsers, removeContentTypeParser } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/content-type-parser'
import { ApplicationHook, HookAsyncLookup, HookLookup, LifecycleHook, onCloseAsyncHookHandler, onCloseHookHandler, onErrorAsyncHookHandler, onErrorHookHandler, onListenAsyncHookHandler, onListenHookHandler, onReadyAsyncHookHandler, onReadyHookHandler, onRegisterHookHandler, onRequestAbortAsyncHookHandler, onRequestAbortHookHandler, onRequestAsyncHookHandler, onRequestHookHandler, onResponseAsyncHookHandler, onResponseHookHandler, onRouteHookHandler, onSendAsyncHookHandler, onSendHookHandler, onTimeoutAsyncHookHandler, onTimeoutHookHandler, preCloseAsyncHookHandler, preCloseHookHandler, preHandlerAsyncHookHandler, preHandlerHookHandler, preParsingAsyncHookHandler, preParsingHookHandler, preSerializationAsyncHookHandler, preSerializationHookHandler, preValidationAsyncHookHandler, preValidationHookHandler } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/hooks'
import { FastifyBaseLogger, FastifyChildLoggerFactory } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/logger'
import { FastifyRegister } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/register'
import { FastifyReply } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/reply'
import { FastifyRequest } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/request'
import { RouteGenericInterface, RouteHandlerMethod, RouteOptions, RouteShorthandMethod } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/route'
import {
  FastifySchema,
...
} from '.pnpm/fastify@5.4.0/node_modules/fastify/types/schema'
import {
  FastifyTypeProvider,
  FastifyTypeProviderDefault,
  SafePromiseLike
} from '.pnpm/fastify@5.4.0/node_modules/fastify/types/type-provider'
import { ContextConfigDefault, HTTPMethods, RawReplyDefaultExpression, RawRequestDefaultExpression, RawServerBase, RawServerDefault } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/utils'
