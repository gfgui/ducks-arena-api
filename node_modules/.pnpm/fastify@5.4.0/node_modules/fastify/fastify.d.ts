...
import { AddContentTypeParser, ConstructorAction, FastifyBodyParser, FastifyContentTypeParser, getDefaultJsonParser, hasContentTypeParser, ProtoAction } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/content-type-parser'
import { FastifyContextConfig, FastifyReplyContext, FastifyRequestContext } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/context'
import { FastifyErrorCodes } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/errors'
import { DoneFuncWithErrOrRes, HookHandlerDoneFunction, onCloseAsyncHookHandler, onCloseHookHandler, onErrorAsyncHookHandler, onErrorHookHandler, onListenAsyncHookHandler, onListenHookHandler, onReadyAsyncHookHandler, onReadyHookHandler, onRegisterHookHandler, onRequestAbortAsyncHookHandler, onRequestAbortHookHandler, onRequestAsyncHookHandler, onRequestHookHandler, onResponseAsyncHookHandler, onResponseHookHandler, onRouteHookHandler, onSendAsyncHookHandler, onSendHookHandler, onTimeoutAsyncHookHandler, onTimeoutHookHandler, preCloseAsyncHookHandler, preCloseHookHandler, preHandlerAsyncHookHandler, preHandlerHookHandler, preParsingAsyncHookHandler, preParsingHookHandler, preSerializationAsyncHookHandler, preSerializationHookHandler, preValidationAsyncHookHandler, preValidationHookHandler, RequestPayload } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/hooks'
import { FastifyInstance, FastifyListenOptions, PrintRoutesOptions } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/instance'
import {
  FastifyBaseLogger,
  ...
  LogLevel,
  PinoLoggerOptions
} from '.pnpm/fastify@5.4.0/node_modules/fastify/types/logger'
import { FastifyPlugin, FastifyPluginAsync, FastifyPluginCallback, FastifyPluginOptions } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/plugin'
import { FastifyRegister, FastifyRegisterOptions, RegisterOptions } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/register'
import { FastifyReply } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/reply'
import { FastifyRequest, RequestGenericInterface } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/request'
import { RouteGenericInterface, RouteHandler, RouteHandlerMethod, RouteOptions, RouteShorthandMethod, RouteShorthandOptions, RouteShorthandOptionsWithHandler } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/route'
import { FastifySchema, FastifySchemaCompiler, FastifySchemaValidationError, SchemaErrorDataVar, SchemaErrorFormatter } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/schema'
import { FastifyServerFactory, FastifyServerFactoryHandler } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/serverFactory'
import { FastifyTypeProvider, FastifyTypeProviderDefault, SafePromiseLike } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/type-provider'
import { ContextConfigDefault, HTTPMethods, RawReplyDefaultExpression, RawRequestDefaultExpression, RawServerBase, RawServerDefault, RequestBodyDefault, RequestHeadersDefault, RequestParamsDefault, RequestQuerystringDefault } from '.pnpm/fastify@5.4.0/node_modules/fastify/types/utils'
